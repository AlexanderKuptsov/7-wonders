...
public class CameraUpDown : MonoBehaviour {
	...
	[Tooltip("Zoom on start")]       
    [Range(10, 70)]
    public int startingZoom = 45;
	[Tooltip("Min zoom border")] 
    [Range(1, 178)]
    public int minZoom = 15;
	[Tooltip("Max zoom border")] 
    [Range(2, 179)]
	...
	[Space] 
	[Header("Free view")]
	[Tooltip("Allow free camera mode")] 
    ...
    [Tooltip("Set borders length")] 
	public int bordersLength = 20;
	...
	private const float SPEED_NORM = 0.2f;
	private const float SPEED_Resize_NORM = 100f;
	private const float ZOOM_SPEED_NORM = 50f;
    ...
    void Start()
    {
		...
		speed *= SPEED_NORM;
		zoomSpeed *= ZOOM_SPEED_NORM;
        speedResize = speed * SPEED_Resize_NORM;
    }
