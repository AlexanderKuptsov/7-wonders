        ...
        where TCardData : CommonCardData
    {
        ...
        public Sprite GetCost()
        {
            ...
            if (cost.Length == 2)
            {
                for (int i = 0; i < cost.Length; i++)
                {
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 1)
                    {
                        ...
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_ore_ore");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 1)
                    {
                        ...
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_papyrus");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 1)
                    {
                        ...
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_brick_brick_brick");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 2)
                    {
                        ...
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_wood_ore");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 1)
                    {
                        ...
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/stone_ore_ore_ore");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 2)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.CLOTH &&
                            cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/stone_stone_loom");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 3)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.GLASS &&
                            cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/stone_stone_stone_glass");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 3)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/stone_stone_stone_ore");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 2)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.CLOTH &&
                            cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/brick_brick_loom");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 2)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.PAPYRUS &&
                            cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/clay_clay_papyrus");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 3)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.GLASS &&
                            cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/brick_brick_brick_glass");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 2)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.GLASS &&
                            cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_ore_glass 1");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 2)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.STONE &&
                            cost[i + 1].Amount == 2)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_ore_stone_stone");
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.GLASS && cost[i].Amount == 1)
                    {
                        if (cost[i + 1].Currency == Resources.Resource.CurrencyProducts.STONE &&
                            cost[i + 1].Amount == 1)
                        {
                            Cost = UnityEngine.Resources.Load<Sprite>("Effects/glass_stone");
                        }
                    }
                }
            }
                ...
                for (int i = 0; i < cost.Length; i++)
                {
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.GLASS && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_brick_glass");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.PAPYRUS && cost[i].Amount == 1)
                        {
                            ...
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_papyrus_loom");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 2)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.PAPYRUS && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.GLASS && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_wood_papyrus_glass");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 2)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 2)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.PAPYRUS && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_wood_ore_ore_papyrus");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 3)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/wood_wood_wood_stone_loom");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.GLASS && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 2)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/glass_ore_stone_stone");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 2)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_stone_wood_wood");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_brick_wood");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 2)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_wood_wood_loom");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 2)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.GLASS && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_ore_glass_loom");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 2)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_ore_stone_loom");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 2)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.PAPYRUS && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/brick_brick_loom_papyrus");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 3)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.PAPYRUS && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/brick_brick_brick_loom_papyrus");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.ORE && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.WOOD && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/loom_ore_wood");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLOTH && cost[i].Amount == 1)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.PAPYRUS && cost[i].Amount == 1)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.GLASS && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/loom_papyrus_glass");
                            }
                        }
                    }
                    ...
                    if (cost[i].Currency == Resources.Resource.CurrencyProducts.STONE && cost[i].Amount == 2)
                    {
                        ...
                        if (cost[i].Currency == Resources.Resource.CurrencyProducts.CLAY && cost[i].Amount == 2)
                        {
                            ...
                            if (cost[i].Currency == Resources.Resource.CurrencyProducts.GLASS && cost[i].Amount == 1)
                            {
                                Cost = UnityEngine.Resources.Load<Sprite>("Effects/stone_stone_clay_clay_glass");
                            }
                        }
                    }
                }
            ...
            if (cost.Length == 4)
            {
                ...
                Cost = UnityEngine.Resources.Load<Sprite>("Effects/ore_ore_brick_stone_wood");
            }
